...
def collect_image_paths(data_dir):
    ...
    crawler_ = futil.FileSystemDataCrawler(root_dir=data_dir,
                                           file_keys=image_keys,
                                           file_path_generator=MyFilePathGenerator(),
                                           dir_filter=dir_filter)  # todo: modify here
...
def load_images(image_paths):
    ...
    #img = sitk.ReadImage(image_paths)
...
def register_images(image_dict, atlas_img):
    ...
    registered_gt = sitk.Resample(gt_img, atlas_img, registration.transform,
                                  sitk.sitkNearestNeighbor)  # todo: modify here
...
def preprocess_filter_rescale_t1(image_dict, new_min_val, new_max_val):
    ...
    filter_ = MinMaxRescaleFilter()     # make sure to add parenthesis # todo: modify here
